...
_path_output_performance_user_level = 'path_output_performance_user_level'
...
class NameSpaceModel:
    ...
    def fill_base(self):
        ...
        default_user_level_performance = os.sep.join(["..", "results", "{0}", "user_level"])
        ...
        self.config[_experiment][_performance] = os.path.abspath(self.config[_experiment]\
            ...
            .format(self.config[_experiment][_dataset]))
        self.config[_experiment][_path_output_performance_user_level] = os.path.abspath(self.config[_experiment]\
            .get(_path_output_performance_user_level, self._set_path(self._base_folder_path_config, default_user_level_performance)) \
            .format(self.config[_experiment][_dataset]))
        ...
        manage_directories(self.config[_experiment][_recs], self.config[_experiment][_weights],
                           self.config[_experiment][_performance], self.config[_experiment][_path_output_performance_user_level], )

        for p in [_data_config, _weights, _recs, _dataset, _top_k, _performance,_path_output_performance_user_level, _logger_config,
