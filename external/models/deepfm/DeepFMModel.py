...
class DeepFMModel(nn.Module):
    def __init__(self, num_users, num_items, num_features, embed_dim, deep_layers, dropout_rate, learning_rate, random_seed):
        ...
        deep_layers.append(1) #  add output dim of 1
        deep_modules = []
        for output_dim in deep_layers:
            deep_modules.append(nn.Linear(deep_input_dim, output_dim))
