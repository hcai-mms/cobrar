...
class CoBraRBPRModel(torch.nn.Module, ABC):
    def __init__(self,
                 num_users,
                 num_items,
                 embedding_dim,
        ...
        self.name = 'CollaborativeBranchRecommenderBPR'
    ...
    def get_item_representations(self, items):
        # ToDo check if this needs to be adapted for 1 + num_negs
    ...
    def predict(self, gu, gi, **kwargs):
        """
        this is substantially different from DeepMF
        """
    ...
    def train_step(self, batch):
        ...
        user_repr, pos_item_repr = self.forward(inputs=(user, pos))
        _, neg_item_repr = self.forward(inputs=(user, neg))
